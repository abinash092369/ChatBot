...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'flex flex-col border-r bg-card transition-all duration-300 z-50 h-screen',
          // Desktop positioning
          'md:sticky md:top-0 md:z-30 md:flex',
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-border">
          <Link href="/dashboard" onClick={closeMobile} className="flex items-center space-x-3">
        ...
        <div className="p-3 space-y-2">
          {(!collapsed || mobileOpen) && <OrgSwitcher />}
          {!isAdmin && (
            <button
          ...
          {isAdmin ? (
            <>
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Control Center</span>}
              </Link>
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>System & User Intelligence</span>}
              </Link>
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Security Audit Logs</span>}
              </Link>
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Org & Workspaces</span>}
              </Link>
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>API Key Management</span>}
              </Link>
            </>
          ) : (
            <>
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Knowledge (RAG)</span>}
              </Link>
              <Link
                href="/tools"
                onClick={closeMobile}
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Tools Gallery</span>}
              </Link>
              <Link
                href="/prompts"
                onClick={closeMobile}
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Prompt Library</span>}
              </Link>
              <Link
                href="/workflows"
                onClick={closeMobile}
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Workflows</span>}
              </Link>
              <Link
                href="/billing"
                onClick={closeMobile}
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Billing & Subscriptions</span>}
              </Link>
              <Link
                href="/apikeys"
                onClick={closeMobile}
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Org & Teams</span>}
              </Link>
              <Link
                href="/analytics"
                onClick={closeMobile}
              ...
              >
                ...
                {(!collapsed || mobileOpen) && <span>Usage & Activity</span>}
              </Link>
            </>
          )}
        </div>
            ...
            <div className="flex-1 overflow-y-auto px-3 space-y-4">
              {pinnedList.length > 0 && (
                <div className="space-y-1">
                  {(!collapsed || mobileOpen) && <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider px-2">Pinned</p>}
                  {pinnedList.map((conv) => (
                    <div
                      key={conv.id}
                    ...
                    >
                      <div className="flex items-center space-x-2.5 min-w-0">
                        ...
                        {(!collapsed || mobileOpen) && <span className="truncate">{conv.title}</span>}
                      </div>
              ...
              <div className="space-y-1">
                {(!collapsed || mobileOpen) && <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider px-2">Recent Chats</p>}
                {recentList.length === 0 ? (
                  (!collapsed || mobileOpen) && <p className="text-xs text-muted-foreground px-2 py-4">No conversations yet.</p>
                ) : (
                  recentList.map((conv) => (
                    <div
                      key={conv.id}
                    ...
                    >
                      ...
                      {(!collapsed || mobileOpen) && editingId !== conv.id && (
                        <div className="opacity-0 group-hover:opacity-100 flex items-center space-x-1">
        ...
        <div className="border-t border-border p-3 space-y-1">
          ...
          >
            ...
            {(!collapsed || mobileOpen) && <span>Audit Trail</span>}
          </Link>
        </div>
      </aside>
    </>
